	...
	Selectpicker.prototype = {
		...
		createDropdown: function () {
			...
			var searchbox = this.options.liveSearch
				? '<div class="bootstrap-select-searchbox"><input type="text" aria-label="search options" style="width: 100%" class="input-block-level form-control" /></div>'
				: "";
			var actionsbox = this.options.actionsBox
				? '<div class="bs-actionsbox">' +
				  '<div class="btn-group btn-block">' +
				  '<button aria-label="select all options" class="actions-btn bs-select-all btn btn-sm btn-default">' +
				  "Select All" +
				  "</button>" +
				  '<button aria-label="deselect all options" class="actions-btn bs-deselect-all btn btn-sm btn-default">' +
				  "Deselect All" +
				  "</button>" +
				  "</div>" +
				  "</div>"
			...
			var drop =
				...
				inputGroup +
				'">' +
				'<button aria-expanded="false" aria-haspopup="listbox" class="btn dropdown-toggle selectpicker" data-toggle="dropdown"' +
				autofocus +
				">" +
		...
		createLi: function () {
				...
				if (
					...
					if ($this.index() === 0) {
						...
						var labelIcon = $this.parent().data("icon")
							...
							: "";
						label =
							labelIcon + '<span class="text">' + label + labelSubtext + "</span>";
			...
			$.each(_liA, function (i, item) {
				...
				_liHtml += '<li role="option" rel="' + i + '"' + hide + ">" + item + "</li>";
			});
		...
		render: function (updateLi) {
			...
			this.$button.attr("aria-label", $.trim(title));
			...
			this.$searchbox.on("input propertychange", function () {
				if (that.$searchbox.val()) {
					...
					if (!that.$menu.find("li").filter(":visible:not(.no-results)").length) {
						if (!!no_results.parent().length) no_results.remove();
						no_results
							.html(that.options.noneResultsText + ' "' + that.$searchbox.val() + '"')
							.show();
