...
a structural refinancing model indicate that origination delays impose an average present-value loss of about $3,090 per affected borrower, equivalent to roughly $1.3 billion in annual costs when aggregated across delayed borrowers. The structural model further highlights distributional heterogeneity in these losses, a general equilibrium effect on mortgage pricing, and policy counterfactuals—such as an initial-rate concession or a separating-equilibrium scheme—that could substantially mitigate the costs.
 </div>
 </details>
 </div>
  </li>
